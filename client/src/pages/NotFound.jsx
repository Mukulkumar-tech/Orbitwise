  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-canvas px-5">
      <div className="w-full max-w-md text-center">
        ...
        <p className="mt-6 font-mono text-sm font-semibold tracking-widest text-primary-700">404</p>
        ...
        <Link
          to="/"
          className="mt-8 inline-flex items-center gap-2 rounded-xl bg-primary-500 px-5 py-3 text-sm font-semibold text-navy-950 shadow-primary transition-colors duration-150 hover:bg-primary-400"
        >
